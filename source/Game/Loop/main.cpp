...
int main() {
    ...
    Button button((char*) "../res/front.jpg", glm::vec2(0.3f, 0.5f), glm::vec2(0.4, 0.05), [&hdr](){hdr.setHDR(!hdr.getToggle());}, &window, std::vector<glm::vec2> {glm::vec2(0.5f,  0.5f), glm::vec2(0.5f, -0.5f), glm::vec2(-0.5f,  0.5f), glm::vec2(-0.5f, -0.5f)}, std::vector<glm::vec2> {glm::vec2(0,  0), glm::vec2(0, 1), glm::vec2(1,  0), glm::vec2(1, 1)}, std::vector<unsigned int> {0, 1, 2, 1, 3, 2});
